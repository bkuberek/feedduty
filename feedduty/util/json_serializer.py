# -*- coding: utf-8 -*-
# Class borrowed from http://prschmid.blogspot.com/2012/12/json-serializing-sqlalchemy-objects.html
#
# Author:  Patrick Schmid
# Modified by: Bastian Kuberek <bkuberek@spotify.com>
...
class JsonSerializer(object):
    ...
    #: included here, no special serializer will be used.
    #: The implementor needs to provide these.
    ...
    serializers = dict(
        ...
        # serializer=dict(
        #     serialize=lambda x, y: x.serialize(y),
        #     deserializer=lambda x, y: x.deserialize(y)
        # )
    )
